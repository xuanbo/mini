...
import xinQing.mini.security.LimitLoginAuthenticationProvider;
import xinQing.mini.security.LoginAuthenticationFilter;
import xinQing.mini.security.MyAuthenticationFailureHandler;
import xinQing.mini.security.MyAuthenticationSuccessHandler;
import xinQing.mini.security.MyUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/core/**").hasRole("ADMIN")//   需要ROLE_ADMIN角色
